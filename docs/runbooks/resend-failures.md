...
| ------------------------- | ------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Usage-warning composition | `RESEND_FROM_EMAIL`; optional `RESEND_REPLY_TO_EMAIL`; owner must have an email | Configuration missing during provider-result persistence pauses the tracking source with `pauseReason: "config"`. Missing recipient at a crossed threshold fails the atomic ingestion attempt. |
