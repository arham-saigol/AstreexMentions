...
const FRONTEND_ARGUMENT_KEYS = {
  ...
  "admin:listFeatureRequests": ["cursor", "limit", "query", "sort", "status"],
  ...
  "billing/customer:getBillingOverview": ["now"],
  ...
  "changelog:getPublishedEntry": ["slug"],
  "changelog:listPublishedEntries": ["cursor"],
