...
const badgeVariants = cva(
  "inline-flex min-h-6 w-fit shrink-0 items-center justify-center gap-1 overflow-hidden rounded-full border px-2 py-0.5 text-xs font-medium whitespace-nowrap transition-colors duration-[var(--motion-control)] [&>svg]:pointer-events-none [&>svg]:size-3",
  {
    variants: {
      variant: {
